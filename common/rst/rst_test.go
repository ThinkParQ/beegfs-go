...
// staying unset: IsWorkRequestReady and ExecuteWorkRequestPart both gate their bulk-specific defers
// on request.HasBulkInfo() for the *flex.WorkRequest RecreateWorkRequests builds, not the JobRequest.
