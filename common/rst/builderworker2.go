...
type requestBuilderWorker2 struct {
...
func (c *JobBuilderClient) newRequestBuilderWorker2(
	builderCfg *flex.JobRequestCfg,
	jobSubmissionCh chan<- *beeremote.JobRequest,
	tryRouteToBulkOperation tryRouteToBulkOperationFn,
	jobRequestCountsCh chan<- *jobRequestCounts,
) *requestBuilderWorker2 {
	return &requestBuilderWorker2{
...
func (w *requestBuilderWorker2) Process(ctx context.Context, inMountPath string, remotePath string, failedPrecondition error) (err error) {
...
func (w *requestBuilderWorker2) resolvePathStateForRequest(ctx context.Context, inMountPath string) (state PathState, skip bool, pathIssue error, err error) {
...
func (w *requestBuilderWorker2) buildJobRequestCfgs(inMountPath string, remotePath string, rstIds []uint32, lockedInfo *flex.JobLockedInfo, cfg *flex.JobRequestCfg) []*flex.JobRequestCfg {
...
func (w *requestBuilderWorker2) processJobRequestCfg(ctx context.Context, cfg *flex.JobRequestCfg, pathState PathState, failedPrecondition error, result *jobRequestCounts) (canReleaseLock bool, err error) {
...
func (w *requestBuilderWorker2) prepareJobRequestForSubmission(ctx context.Context, request *beeremote.JobRequest, cfg *flex.JobRequestCfg, entryInfo msg.EntryInfo, ownerNode beegfs.Node) (canReleaseLock bool) {
	canReleaseLock = true
...
func (w *requestBuilderWorker2) buildJobRequest(ctx context.Context, cfg *flex.JobRequestCfg, failedPrecondition error) *beeremote.JobRequest {
...
func (w *requestBuilderWorker2) submitJobRequest(ctx context.Context, request *beeremote.JobRequest, result *jobRequestCounts) {
	select {
	case <-ctx.Done():
		return
