...
func (t *UnderlyingFSType) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var s string
...
func (t UnderlyingFSType) MarshalYAML() (interface{}, error) {
	switch t {
	case EXT4UnderlyingFS:
		return "ext4", nil
	default:
...
func FromProto(protoFS *pb.Filesystem) Filesystem {
	...
	fs.MetaConfig = protoFS.GetMetaConfig()
	fs.StorageConfig = protoFS.GetStorageConfig()
	fs.ClientConfig = protoFS.GetClientConfig()
