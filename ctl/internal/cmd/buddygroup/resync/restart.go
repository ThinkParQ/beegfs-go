...
func newRestartCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Abort any active resyncs for a storage buddy group and start a new one",
		Long: `Abort any active resyncs for a storage buddy group and start a new one.
