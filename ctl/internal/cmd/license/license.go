	...
	default:
		...
		if len(scopes) > 0 {
			...
			if slices.Contains(scopes, "beeond") {
				fmt.Println("  - This is a license for BeeOND (BeeGFS On Demand) filesystems")
			}
		}
	}
	return ret
...
A community license for this filesystem can be generated by pasting the following URL into your web browser:
